...
bool Math::IsRandomSeedInitialized;
uint32 Math::Crc32Table[256] =
{
...
int32 Math::Random(int32 min, int32 maxExclusive)
{
...
uint32 Math::ComputeCRC32(const void *buffer, int32 size)
{
