...
private:
	...
	bool DrawClippedTriangleT(ShadowMapStencilVertex v1, ShadowMapStencilVertex v2, ShadowMapStencilVertex v3) const;
	template<bool hasTexture>
	void DrawScanlineT(ShadowMapStencilScanlineParameters p) const;
};